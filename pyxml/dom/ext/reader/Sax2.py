...
from pyxml.sax import saxlib, saxutils, sax2exts, handler
from pyxml.dom import Entity, DocumentType, Document
from pyxml.dom import Node
from pyxml.dom import implementation
from pyxml.dom.ext import SplitQName, ReleaseNode
from pyxml.dom import XML_NAMESPACE, XMLNS_NAMESPACE, EMPTY_NAMESPACE
from pyxml.dom import Element
from pyxml.dom import Attr
from pyxml.dom.ext import reader
...
class Reader(reader.Reader):
    def __init__(self, validate=0, keepAllWs=0, catName=None,
        ...
        if catName:
            ...
            from pyxml.parsers.xmlproc import catalog
