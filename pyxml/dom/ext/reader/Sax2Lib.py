...
class LexicalHandler:
    ...
    """
    handlerId = 'http://pyxml.org/sax/handlers/lexical'
...
class DTDDeclHandler:
    ...
    handlerId = 'http://pyxml.org/sax/handlers/dtd-decl'
...
class NamespaceHandler:
    ...
    handlerId = 'http://pyxml.org/sax/handlers/namespace'
...
CoreHandlers = [
'http://pyxml.org/sax/handlers/lexical',
'http://pyxml.org/sax/handlers/dtd-decl',
'http://pyxml.org/sax/handlers/namespace'
]

CoreProperties = [
'http://pyxml.org/sax/properties/namespace-sep',
#write-only string
...
#(see the http://pyxml.org/sax/features/namespaces feature).  By
...
'http://pyxml.org/sax/properties/dom-node',
...
'http://pyxml.org/sax/properties/xml-string'
#read-only string
...
CoreFeatures = [
'http://pyxml.org/sax/features/validation',
#Validate (1) or don't validate (0).

'http://pyxml.org/sax/features/external-general-entities',
...
'http://pyxml.org/sax/features/namespaces',
#Preprocess namespaces (1) or don't preprocess (0).  See also

#the http://pyxml.org/sax/properties/namespace-sep property.
'http://pyxml.org/sax/features/normalize-text'
