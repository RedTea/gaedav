...
from pyxml.dom.ext.Visitor import Visitor, WalkerInterface
from pyxml.dom import ext, XMLNS_NAMESPACE, XML_NAMESPACE, XHTML_NAMESPACE
from pyxml.dom.html import TranslateHtmlCdata
from pyxml.dom.html import HTML_4_TRANSITIONAL_INLINE
from pyxml.dom.html import HTML_FORBIDDEN_END
from pyxml.dom.html import HTML_BOOLEAN_ATTRS
...
try:
    ...
    def utf8_to_code(text, encoding):
        ...
        if encoding == 'UTF-8':
            return text
        from pyxml.unicode.iso8859 import wstring
