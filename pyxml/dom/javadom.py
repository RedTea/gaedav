...
class BaseDomImplementation:
    ...
    def buildDocumentString(self, string):
        ...
        from org.pyxml.sax import InputSource
...
class SunDomImplementation:
    ...
    def createDocument(self):
        from com.sun.pyxml.tree import XmlDocument
        return Document(XmlDocument())

    def buildDocumentString(self, string):
        from com.sun.pyxml.tree import XmlDocumentBuilder
...
class BrownellDomImplementation(BaseDomImplementation):
    ...
    def createDocument(self):
        from org.brownell.pyxml.dom import DomDocument
