...
from pyxml.dom import NamespaceErr
from pyxml.dom import NotFoundErr
from pyxml.dom import NotSupportedErr
from pyxml.dom import HierarchyRequestErr
from pyxml.dom import WrongDocumentErr
from pyxml.dom import InvalidCharacterErr
from pyxml.dom import UnspecifiedEventTypeErr
from pyxml.dom import XML_NAMESPACE
...
def get_name_pattern():
    ...
    try:
        ...
        import pyxml.utils.characters
        _namePattern = re.compile(pyxml.utils.characters.Name+'\Z')
    return _namePattern
