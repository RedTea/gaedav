...
import string
from pyxml.sax import xmlreader, saxutils
from pyxml.sax.handler import feature_namespaces
from pyxml.sax import _exceptions
...
try:
    ...
    from org.pyxml.sax import ContentHandler, SAXException
    from org.pyxml.sax.helpers import XMLReaderFactory
except ImportError:
    raise SAXReaderNotAvailable("SAX is not on the classpath", None)

# get some JAXP stuff
try:
    from javax.pyxml.parsers import SAXParserFactory, ParserConfigurationException
