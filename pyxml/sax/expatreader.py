...
from pyxml.sax._exceptions import *
from pyxml.sax.handler import feature_validation, feature_namespaces
from pyxml.sax.handler import feature_namespace_prefixes
from pyxml.sax.handler import feature_external_ges, feature_external_pes
from pyxml.sax.handler import feature_string_interning
from pyxml.sax.handler import property_xml_string, property_interning_dict

# pyxml.parsers.expat does not raise ImportError in Jython
import sys
...
try:
    from pyxml.parsers import expat
except ImportError:
    raise SAXReaderNotAvailable("expat not supported", None)
else:
    if not hasattr(expat, "ParserCreate"):
        raise SAXReaderNotAvailable("expat not supported", None)
from pyxml.sax import xmlreader, saxutils, handler
...
if __name__ == "__main__":
    import pyxml.sax
    p = create_parser()
    p.setContentHandler(pyxml.sax.XMLGenerator())
    p.setErrorHandler(pyxml.sax.ErrorHandler())
    p.parse("../../../hamlet.xml")
