...
import pyxml.parsers.xmlproc.dtdparser
import pyxml.parsers.xmlproc.xmlapp
from pyxml.sax.saxutils import escape
...
class _XMLDTDLoader(pyxml.parsers.xmlproc.xmlapp.DTDConsumer):
    def __init__(self, info, parser):
        self.info = info
        pyxml.parsers.xmlproc.xmlapp.DTDConsumer.__init__(self, parser)
...
class XMLDoctypeInfo(DoctypeInfo):
    def load_pubtext(self, sysid):
        parser = pyxml.parsers.xmlproc.dtdparser.DTDParser()
