...
XMLParserFactory=ParserFactory(["pyxml.sax.drivers.drv_pyexpat",
                                "pyxml.sax.drivers.drv_xmltok",
                                "pyxml.sax.drivers.drv_xmlproc",
                                "pyxml.sax.drivers.drv_xmltoolkit",
                                "pyxml.sax.drivers.drv_xmllib",
                                "pyxml.sax.drivers.drv_xmldc",
                                "pyxml.sax.drivers.drv_sgmlop"])

XMLValParserFactory=ParserFactory(["pyxml.sax.drivers.drv_xmlproc_val"])

HTMLParserFactory=ParserFactory(["pyxml.sax.drivers.drv_htmllib",
                                 "pyxml.sax.drivers.drv_sgmlop",
                                 "pyxml.sax.drivers.drv_sgmllib"])

SGMLParserFactory=ParserFactory(["pyxml.sax.drivers.drv_sgmlop",
                                 "pyxml.sax.drivers.drv_sgmllib"])
