...
from pyxml.dom import XML_NAMESPACE,EMPTY_NAMESPACE
from pyxml.dom import Node
from pyxml.dom.NodeFilter import NodeFilter
from pyxml.xpath import g_xpathRecognizedNodes, Compile
...
def ExpandQName(qname, refNode=None, namespaces=None):
    ...
    nss = {}
    if refNode:
        nss = pyxml.dom.ext.GetAllNs(refNode)
    elif namespaces:
        nss = namespaces
    (prefix, local) = pyxml.dom.ext.SplitQName(qname)
