...
from pyxml.dom import EMPTY_NAMESPACE
from pyxml.dom.ext import SplitQName
from pyxml.xpath import CompiletimeException, RuntimeException
from pyxml.xpath import g_extFunctions
from pyxml.xpath import ParsedNodeTest
from pyxml.xpath import CoreFunctions, Conversions
from pyxml.xpath import Util
from pyxml.xpath import ParsedStep
from pyxml.xpath import ParsedAxisSpecifier
...
class ParsedPathExpr:
    def __init__(self, descendant, left, right):
        ...
        if descendant:
            ...
            from pyxml.xpath import ParsedPredicateList
...
from pyxml.xpath import Inf, NaN
