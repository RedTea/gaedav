...
class PropertyManager(object):
    ...
    def _performInitialization(self):
        ...
        try:
            ...
            # TODO In appengine we can't write file, so let self._dict be a normal dict,
            # however to implement a functional locker we should use datastore
            self._dict = utils.FakeShelve()
        finally:
